...
**Uptime.** Validators that miss blocks earn fewer rewards and may face slashing penalties. Check uptime history on [Pocket Explorer](https://explorer.pocket.network/validators).
...
<Callout type="tip">
You can query the validator set directly with `pocketd query staking validators` or browse them on [Pocket Explorer](https://explorer.pocket.network/validators).
</Callout>
...
- `pocketd` installed ([pocketd CLI](/pocketd/))
...
- [Explorer & Analytics](/ecosystem/explorer) — explorer for validator stats
