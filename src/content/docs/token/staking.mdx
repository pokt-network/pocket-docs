...
1. **Find a pool.** Browse active staking pools — linked from the [Pocket Network Discord](http://discord.gg/pocket-network), and verify operators on [Pocket Explorer](https://explorer.pocket.network/suppliers). Compare fee structures and track records.
...
- **Track record:** Check node stake and status on [Pocket Explorer](https://explorer.pocket.network/suppliers), and relay trends on [Pocket Analytics](https://analytics.pocket.network). Look for consistent relay volume and minimal downtime.
...
4. **Monitor performance** on [Owner Staking](https://analytics.pocket.network/owner-staking).
...
<Callout type="info">
  There is no fixed annual yield to quote. Reward rates depend on total network relay volume, competing nodes, and POKT/USD price. Published APR estimates from third parties are indicative only — verify against current [Pocket Analytics](https://analytics.pocket.network) data.
</Callout>
