...
You can verify the current settings on-chain:

- **Current mint ratio:** [explorer.pocket.network/params](https://explorer.pocket.network/params) → Tokenomics Parameters → `mint_ratio` (should show `0.975`)
- **Reward distribution:** Tokenomics Parameters → `mint_equals_burn_claim_distribution`
- **Supply evolution:** [Pocket Analytics](https://analytics.pocket.network/?tab=economy) → Economy tab
