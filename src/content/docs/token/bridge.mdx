...
7. **Verify** on [Pocket Explorer](https://explorer.pocket.network)
...
**Native POKT hasn't arrived after 45+ minutes:** Check bridge transaction status using the provided hash. Verify the destination on Pocket Explorer. If the source chain confirms but POKT hasn't arrived, check [Discord](http://discord.gg/pocket-network) #bridge-support.
