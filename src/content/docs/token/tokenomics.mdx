...
- At current relay volume, burn roughly equals mint — near-neutral inflation. For the live daily burn rate, see [pokt.money](https://pokt.money) or [POKTscan](https://poktscan.com)
...
- Total network supply: <NetworkStat metric="total_supply" format="billions" fallback="see POKTscan" /> POKT (live from chain). For current staked supply and the staked percentage, see [POKTscan](https://poktscan.com)
