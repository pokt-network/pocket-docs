...
[PIP-41](/token/pip-41) activated a structural burn mechanism: for every 100 POKT burned by applications, only 97.5 POKT is minted back. The remaining 2.5% is permanently removed from circulation.
