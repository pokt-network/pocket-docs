...
When a proposal passes, PNF or the designated implementer carries it out. Parameter changes (PUPs) can be executed quickly via governance transactions. Protocol changes (PIPs) require development and testing. After implementation, changes can be verified at [explorer.pocket.network/params](https://explorer.pocket.network/params).
...
- **On-chain parameters:** [explorer.pocket.network/params](https://explorer.pocket.network/params)
