...
4. **Verify sync** — check your node's block height against [Pocket Explorer](https://explorer.pocket.network)
...
Track past upgrades and their effects at [explorer.pocket.network/params](https://explorer.pocket.network/params) — parameter changes are recorded on-chain with the block height where they took effect.
