...
For full installation options (Homebrew, manual binary, building from source), see the [pocketd CLI](/pocketd/) section.
...
For full configuration options, see the [pocketd CLI](/pocketd/) section.
...
Track all earnings: [analytics.pocket.network/owner-staking](https://analytics.pocket.network/owner-staking)

What to monitor:
- **Rewards over time** — POKT earned, per address or aggregated
- **Settlement events** — block, service, relays, and the amount settled vs. minted
- **Rewards by service** — which chains generate the most revenue
- **Gaps in settlements** — a service that stops settling is the signal to check your RelayMiner logs
...
- [Service Management](/services/management) — Add or remove services
