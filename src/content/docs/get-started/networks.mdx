...
| **Block time** | ~1 minute | ~30 seconds | Varies |
...
**Key facts:** Chain ID is `pocket-lego-testnet` (renamed from `pocket-beta` in v0.1.31), block time is approximately 30 seconds.

### Faucets

TestNet tokens are free — anyone can request them:

- **POKT and MACT:** [faucet.beta.pocket.network](https://faucet.beta.pocket.network/)
...
| **Block time** | ~1 minute | ~30 seconds |
...
- [Explorer](https://explorer.pocket.network/) · [Analytics](https://analytics.pocket.network/)
- [GraphQL Playground](https://data.pocket.network/)
...
- [Explorer](https://explorer.pocket.network/beta) · [Analytics](https://analytics.pocket.network/beta)
- [GraphQL Playground](https://data.beta.pocket.network/)

### Faucets

- **POKT and MACT (web):** [faucet.beta.pocket.network](https://faucet.beta.pocket.network/)
- **CLI:**
...
The Beta TestNet genesis file is at [pokt-network/pocket-network-genesis](https://github.com/pokt-network/pocket-network-genesis/tree/master/shannon/testnet-lego).
