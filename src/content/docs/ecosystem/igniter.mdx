...
- **Native POKT** in a Pocket mainnet wallet. Check your balance on [Pocket Explorer](https://explorer.pocket.network).
...
- **Track record:** Check their node performance on [Pocket Explorer](https://explorer.pocket.network/suppliers)
...
Track your rewards via [Owner Staking](https://analytics.pocket.network/owner-staking). Add your address to see rewards and settlement history over time.
...
Your stake remains safe. You stop earning rewards for sessions where the provider isn't serving relays, but your tokens are not at risk. Monitor via [Owner Staking](https://analytics.pocket.network/owner-staking) and consider unstaking if downtime persists.
