...
[poktscan.com/tools/staking](https://poktscan.com/tools/staking) — connects to Keplr or Leap wallet for on-chain staking actions directly from POKTscan, without the `pocketd` CLI.
