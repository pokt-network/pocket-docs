...
For more context on staking configuration, see [Application Staking](/developers/application-staking). For an introduction to the network, see [About Pocket Network](/get-started/about-pocket).
